...
// HÀM MỚI: HIỂN THỊ MẪU CHUẨN TRONG POPUP
// HÀM MỚI: HIỂN THỊ MẪU CHUẨN TRONG POPUP
function showMauchuanPopup() {
    // Style cho từng box câu hỏi, mô phỏng lại box trong ảnh mẫu
    const boxStyle = "border: 1px solid #ddd; padding: 15px; border-radius: 5px; background-color: #f9f9f9; margin-bottom: 15px; text-align: left;";

    // Phần giới thiệu
    const introduction = `
        <p class="text-center text-gray-600 mb-6" style="line-height: 1.6;">Nội dung câu hỏi và đáp án đúng <b>in đậm</b>  trong file Word (.docx) để hệ thống nhận diện:</p>
    `;

    const mauChuanContent = `
    <div class="mauchuan-content">
        <h3 class="text-2xl font-bold mb-4 text-center text-blue-700">📋 Mẫu Chuẩn Định Dạng File</h3>
        ${introduction}
        
        <div style="${boxStyle}">
            <p style="font-weight: normal; margin-bottom: 5px;">1. Trong lập trình Socket hướng không kết nối (UDP Socket), gói tin gởi đến đến người nhận không tuân theo quy tắc FIFO</p>
            <p style="margin-left: 15px; margin-bottom: 5px;"><b>a) Đúng</b></p>
            <p style="margin-left: 15px; margin-bottom: 0;">B. Sai</p>
        </div>

        <div style="${boxStyle.replace('margin-bottom: 15px;', 'margin-bottom: 0;')}">
            <p style="font-weight: normal; margin-bottom: 5px;">2. Trình tự nào là đúng cho lập trình Socket ở Client</p>
            <p style="margin-left: 15px; margin-bottom: 5px;"><b>a) Tạo socket, đặt tên socket, kết nối Server, trao đổi dữ liệu, đóng kết nối</b></p>
            <p style="margin-left: 15px; margin-bottom: 5px;">b) Tạo socket, kết nối Server, đặt tên socket, trao đổi dữ liệu, đóng kết nối</p>
            <p style="margin-left: 15px; margin-bottom: 5px;">c) Tạo socket, đặt tên socket, trao đổi dữ liệu, kết nối Server, đóng kết nối</p>
            <p style="margin-left: 15px; margin-bottom: 0;">d) Tất cả A, B, C đều sai</p>
        </div>
    </div>
`;
    // Sử dụng showPopup để hiển thị
    showPopup(mauChuanContent, false);
}